...
#define ZCL_CLUSTER_REVISION_ATTRIBUTE_ID \
    _bdns::BridgedDeviceBasicInformation::Attributes::ClusterRevision::Id
...
DECLARE_DYNAMIC_ATTRIBUTE_LIST_BEGIN(sOnOffAttribs)
    ...
    DECLARE_DYNAMIC_ATTRIBUTE(ZCL_CLUSTER_REVISION_ATTRIBUTE_ID, INT16U, 2, 0),
